...
const { Menu, MenuHandler, MenuList, MenuItem, Avatar, Typography } =
  MaterialTailwind;
    ...
    <Menu>
      <MenuHandler>
        <Avatar
          variant="circular"
          alt="tania andrew"
          className="cursor-pointer rounded-full transition-colors duration-300 ease-in-out hover:bg-black"
          src={CAT}
      ...
      <MenuList placeholder={undefined}>
        <MenuItem
          className="flex items-center gap-2 py-3 px-2 hover:bg-gray-100"
          placeholder={undefined}
        >
          <svg
            width="16"
          ...
          <Typography
            ...
            placeholder={undefined}
          >
            <Link to={`/profile/${data.user?.userId}`}>My profile</Link>
          </Typography>
        </MenuItem>
        <MenuItem
          className="flex items-center gap-2 py-3 px-2 hover:bg-gray-100"
