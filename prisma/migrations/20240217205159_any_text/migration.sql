...
CREATE TABLE "ProductCart" (
    "prodCartId" INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
    "quantity" INTEGER NOT NULL,
    "prodId" INTEGER NOT NULL,
    "userId" INTEGER NOT NULL,
    CONSTRAINT "ProductCart_prodId_fkey" FOREIGN KEY ("prodId") REFERENCES "Product" ("prodId") ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT "ProductCart_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User" ("userId") ON DELETE RESTRICT ON UPDATE CASCADE
);
